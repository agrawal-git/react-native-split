...
function getAssetPathInDrawableFolder(asset) {
  var paths = [];
  asset.scales.forEach(function (scale) {
    var drawableFolder = getAndroidDrawableFolderName(asset, scale);
...
module.exports = {
  getAssetPathInDrawableFolder: getAssetPathInDrawableFolder
};